    ...
    featuredBeers: [
      {
        ...
        abv: 5.2,
        ibu: 15,
        description: 'America\'s first carbon-neutral beer that introduced an entire generation to craft beer. Born from a bike trip through Belgium, it perfectly embodies Colorado\'s outdoor lifestyle and pioneering spirit.',
        tastingNotes: 'Fat Tire delivers a bright and balanced experience with a subtle malt presence, slightly fruity hop profile, and crisp finish. Expect notes of caramel sweetness, light toasted bread, and a clean, refreshing character that makes it incredibly sessionable.',
        rating: 4,
        dayOfWeek: 1,
        imageUrl: '/images/Beer images/Colorado/Fat-Tire-Amber-Ale.jpg'
      },
      {
        id: 'co-02',
        ...
        abv: 9.5,
        ibu: 75,
        description: 'This legendary imperial stout showcases Colorado\'s willingness to push boundaries and create beers that stand up to the rugged Rocky Mountain environment.',
        tastingNotes: 'An onslaught of roasted malt flavor with rich caramel and toffee notes. Bold hop character from American hops creates complexity, while dark chocolate and coffee notes dominate the finish. Full-bodied with warming alcohol presence.',
        rating: 5,
        dayOfWeek: 2,
        imageUrl: '/images/Beer images/Colorado/Great-Divide-Yeti.jpg'
      },
      {
        id: 'co-03',
        name: 'Milk Stout Nitro',
        brewery: 'Left Hand Brewing Company',
        style: 'Sweet Stout (Nitro)',
        abv: 6.0,
        ibu: 25,
        description: 'Left Hand pioneered nitro canning technology, bringing the draft nitro experience home. This innovation represents Colorado\'s technical brewing excellence.',
        tastingNotes: 'Super smooth and creamy with a cascading nitro pour. Aromas of roasted coffee, milk chocolate, brown sugar, and vanilla cream. The lactose creates a silky sweetness that balances the roasted bitterness beautifully.',
        rating: 5,
        dayOfWeek: 3,
        imageUrl: '/images/Beer images/Colorado/Left-Hand-Milk-Stout.jpg'
      },
      {
        id: 'co-04',
        name: '90 Shilling Scottish Ale',
        brewery: 'Odell Brewing Company',
        style: 'Scottish-Style Ale',
        abv: 4.7,
        ibu: 26,
        description: 'Odell\'s flagship beer since 1989, representing the evolution of traditional Scottish brewing in the American craft context with Rocky Mountain character.',
        tastingNotes: 'A smooth, medium-bodied amber ale with a burnished copper color. Complex malty backbone with notes of toffee, caramel, and toasted bread. Balanced hop character provides structure without overwhelming the malt profile.',
        rating: 4,
        dayOfWeek: 4,
        imageUrl: '/images/Beer images/Colorado/Odell-90-Shilling.jpg'
      },
      {
        id: 'co-05',
        name: 'Avery IPA',
        ...
        abv: 6.5,
        ibu: 69,
        description: 'Colorado\'s first packaged IPA, pioneering the state\'s hop-forward beer culture and helping establish Colorado as a major player in the American IPA revolution.',
        tastingNotes: 'Vibrant citrus and pine aromas with grapefruit, tangerine, and resinous hop character. Flavors of orange, peach, and stone fruit supported by a solid malt backbone. Clean, dry finish with lingering hop complexity.',
        rating: 4,
        dayOfWeek: 5,
        imageUrl: '/images/Beer images/Colorado/Avery-IPA.jpg'
      },
      {
        id: 'co-06',
        ...
        abv: 6.5,
        ibu: 65,
        description: 'America\'s first hand-canned craft beer (2002), revolutionizing craft beer packaging and changing perceptions about canned craft beer forever.',
        tastingNotes: 'Hoppy nose with assertive but balanced pale malt and citrusy floral hop flavors. Medium body with a clean, crisp finish. Notable citrus and pine hop character supported by a solid malt foundation.',
        rating: 5,
        dayOfWeek: 6,
        imageUrl: '/images/Beer images/Colorado/Oskar-Blues-Dales.jpg'
      },
      {
        id: 'co-07',
        name: 'Vanilla Porter',
        ...
        abv: 5.4,
        ibu: 16,
        description: 'Showcases Colorado\'s creativity in flavor innovation while respecting traditional styles, using Madagascar vanilla beans to create unique mountain-inspired beers.',
        tastingNotes: 'Rich chocolate and roasted nut flavors typical of porter style, enhanced by authentic Madagascar vanilla. Dark mahogany color with creamy mouthfeel. The vanilla adds sweetness and complexity without overwhelming the base beer.',
        rating: 4,
        dayOfWeek: 7,
        imageUrl: '/images/Beer images/Colorado/Breckenridge-Vanilla-Porter.jpg'
      }
    ],
