...
export default function AlaskaNewsletterTest() {
  ...
  const generatePreview = () => {
    const url = `/api/newsletter/alaska-preview?name=${encodeURIComponent(subscriberName)}&week=2`
    setPreviewUrl(url)
  }
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">
            Alaska Newsletter Email Template Test
          </h1>
          ...
          <div className="space-y-6">
                ...
                <div className="mt-4">
                  ...
                  <div className="mt-4">
                    <iframe
                      ...
                      title="Alaska Newsletter Preview"
                    />
                  </div>
                </div>
              )}
            ...
            <div className="border border-gray-200 p-4 rounded-lg">
              ...
              <div className="bg-yellow-50 border border-yellow-200 p-3 rounded-md mb-4">
                <p className="text-yellow-800 text-sm">
                  ⚠️ This will send the Alaska newsletter to all active subscribers in the database.
              ...
              >
                {loading ? 'Sending...' : 'Send Alaska Newsletter'}
              </button>
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <ul className="space-y-1 text-gray-600">
                    <li>✅ Alaska state hero image</li>
                    <li>✅ Blue/slate color scheme</li>
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-gray-600">
                    ...
                    <li>✅ 7 Alaska beer reviews</li>
                    <li>✅ Beer images included</li>
                    <li>✅ Alaska brewing statistics</li>
            ...
            <div className="border border-gray-200 p-4 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                <p><strong>Preview Endpoint:</strong> /api/newsletter/alaska-preview</p>
                <p><strong>Send Endpoint:</strong> /api/admin/send-approved-content</p>
                <p><strong>Template Component:</strong> /src/emails/AlaskaNewsletterEmail.tsx</p>
