        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                disabled={isLoading || password.trim().length < 3}
          ...
          <div className="mt-6">
            ...
            <div className="mt-3">
              <p className="text-xs text-gray-500 text-center">
                This admin area is protected by authentication. All access attempts are logged for security purposes.
              </p>
            </div>
          </div>
        </div>
